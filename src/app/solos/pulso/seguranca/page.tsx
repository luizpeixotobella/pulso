...
export default async function PulsoSafetyPage() {
  ...
  return (
    <main className="container">
      <section className="panel solos-hero" style={{ marginBottom: 16 }}><p className="section-kicker">Security first</p><h1>Centro de Segurança do Pulso</h1><p>Proteção integral, melhor interesse e privacidade por padrão. O piloto não abre funções de risco só para crescer mais rápido.</p><div className="action-row"><Link className="btn" href="/solos/pulso/feed">Abrir feed seguro</Link><Link className="btn" href="/solos/pulso/regras">Regras da Alpha 0</Link><Link className="btn" href="/privacy-policy">Privacidade</Link><Link className="btn primary" href="/admin/pulso/seguranca">Console do operador · autorizar publicações</Link></div></section>
