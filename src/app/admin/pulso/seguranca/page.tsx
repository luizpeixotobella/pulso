...
export default async function PulsoSafetyAdminPage() {
  ...
  return (
    <main className="container">
      <section className="panel" style={{ marginBottom: 16 }}><p className="section-kicker">Pulso Trust & Safety</p><h1>Fila de segurança</h1><p>IA prioriza; decisões de impacto grave permanecem auditáveis e humanas.</p><div className="action-row"><Link className="btn" href="/admin/pulso">Voltar ao Pulso</Link><Link className="btn primary" href="/admin/ghost">Ghost Brain Monitor</Link></div></section>
